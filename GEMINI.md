...
### TODOs
 - App should have a way to disable or enable logging from an admin menu. Admin menu should be subtle at top of workout app. Logging should be off by default.
